...
sf::Transform SFML_2DCamera::getViewTransform() const
{
	...
	//Example, if camera is at (10,20) an object at (10,20) will be centered
...
sf::Transform SFML_2DCamera::getProjTransform() const
{
	...
	//Note that SCREEN spcae origin point is at the top left corner
	//So we are effectivly shiffting the coordinate by half the screen dimension
	sf::Transform transform = sf::Transform::Identity;
